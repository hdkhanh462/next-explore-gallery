...
function TagsInputItem({
  ...
  return (
    ...
    >
      ...
      <TagsInputPrimitive.ItemDelete className="hover:text-destructive size-4 shrink-0 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100">
